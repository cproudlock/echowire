...
const ERROR_I18N_EN_GB_MESSAGES = defineErrorI18nLocaleMessages({
	...
	"channels_and_guilds.forum_tag_invalid": "One or more of these tags aren't available in this forum.",
	"channels_and_guilds.forum_tag_required": "This forum requires at least one tag on every post.",
	...
	"channels_and_guilds.max_active_threads_reached": "You've reached the maximum of {count, plural, one {# active thread} other {# active threads}}. Archive a thread or post to make room.",
	...
	"channels_and_guilds.max_thread_members_reached": "This thread has reached the maximum of {count, plural, one {# member} other {# members}}.",
	...
	"channels_and_guilds.starter_attachment_already_present": "This attachment is already on the post.",
	"channels_and_guilds.starter_attachment_limit_reached": "The post has reached its attachment limit.",
	"channels_and_guilds.starter_attachment_source_invalid": "The source message can't be the post's own first message.",
