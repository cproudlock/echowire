...
//
// The fork used to keep AV1 out of a separate software preference list, because software AV1
// encoding at share resolutions is far too expensive. Upstream now gates AV1 behind an explicit
