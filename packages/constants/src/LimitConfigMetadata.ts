...
export const LIMIT_KEY_SCOPES: Record<LimitKey, LimitScope> = {
	...
	max_active_threads_per_channel: 'guild',
	max_active_threads_per_guild: 'guild',
	max_thread_members: 'guild',
...
export const LIMIT_KEY_METADATA: Record<LimitKey, LimitKeyMetadata> = {
	...
	max_active_threads_per_channel: {
		key: 'max_active_threads_per_channel',
		label: 'Max Active Threads per Channel',
		description: 'Maximum active (non-archived) threads or forum posts under one channel',
		category: 'channels',
		scope: 'guild',
		isToggle: false,
		unit: 'count',
	...
	max_active_threads_per_guild: {
		key: 'max_active_threads_per_guild',
		label: 'Max Active Threads per Guild',
		description: 'Maximum active (non-archived) threads or forum posts across a guild',
		category: 'channels',
		scope: 'guild',
		isToggle: false,
		unit: 'count',
	...
	max_thread_members: {
		key: 'max_thread_members',
		label: 'Max Thread Members',
		description: 'Maximum members one thread or forum post may hold',
		category: 'channels',
		scope: 'guild',
		isToggle: false,
		unit: 'count',
