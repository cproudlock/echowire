...
// Echowire: shown to the user when a payload carries no title.
const FALLBACK_TITLE: &str = "echowire";
// The category must match what the iOS client registers, which is the
// lowercase form in ios/Shared/PushNotificationPayload.swift. The fork
