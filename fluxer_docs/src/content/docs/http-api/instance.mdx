...
| max_active_threads_per_channel | Maximum unarchived threads under one channel, in guild scope |
| max_active_threads_per_guild | Maximum unarchived threads across a guild, in guild scope |
...
| max_thread_members | Maximum members of one thread, in guild scope |
