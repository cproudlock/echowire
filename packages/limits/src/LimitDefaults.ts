...
export const DEFAULT_RESTRICTED_LIMITS: Record<LimitKey, number> = {
	...
	max_active_threads_per_channel: MAX_ACTIVE_THREADS_PER_CHANNEL,
	max_active_threads_per_guild: MAX_ACTIVE_THREADS_PER_GUILD,
	max_thread_members: MAX_THREAD_MEMBERS,
